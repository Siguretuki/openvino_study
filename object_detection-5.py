...
def run_object_detection(camera_index=0, flip=False, use_popup=False, skip_first_frames=0):
    player = None
    try:
        player = utils.VideoPlayer(
            source=camera_index, flip=flip, fps=30, skip_first_frames=skip_first_frames
        )
...
run_object_detection(camera_index=0, flip=False, use_popup=False)
