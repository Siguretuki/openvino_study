...
def run_object_detection(source=0, flip=False, skip_first_frames=0, output_video_path=None):
    player = None
    video_writer = None
...
run_object_detection(source=video_file, flip=False, skip_first_frames=0, output_video_path=output_video_path)
